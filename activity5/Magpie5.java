...
public class Magpie5
{
    ...
    {
        return "Hey, I used to play Quarterback for the New Orleans Saints and I'm a fraud!";
    }
    ...
    public String getResponse(String statement)
    {
        ...
        {
            response = "My name is Drew Brees, I am one of the greatest frauds of all time.";
        }
        
        else if (findKeyword(statement, "famous") >= 0)
        {
            response = "I was the Saints quarterback for years and I'm known for choking in the playoffs and cheating";
        }
        
        else if (findKeyword(statement, "married") >= 0)
        {
            response = "Im married to my wonderful wife, Britney Brees. She has supported me through my terrible career.";
        }
